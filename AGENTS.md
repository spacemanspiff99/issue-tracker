...
- Treat production-to-UAT/dev data refresh as destructive to the target environment. Require explicit confirmation naming the target environment before overwriting target data, even though the operation is intentionally non-destructive to production.
